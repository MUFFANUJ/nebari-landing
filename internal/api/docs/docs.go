            ...
            "accessrequests.AccessRequest": {
                "properties": {
                    ...
                    "invalidRequiredGroups": {
                        "description": "InvalidRequiredGroups lists current service auth.groups entries that are\nnot full Keycloak paths and must be migrated before access can be approved.",
                        "items": {
                            "type": "string"
                        },
                        "type": "array",
            ...
            "put": {
                ...
                "responses": {
                    ...
                    "409": {
                        ...
                        "description": "Service auth.groups requires migration"
                    },
                    "501": {
                        "content": {
                            "application/json": {
